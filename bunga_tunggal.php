...
<body>
    ...
    <div class="container">
    <h2>Mencari Bunga Tunggal</h2>
<form method="post">
    <label for="M">Modal (M):</label><br>
    <input type="number" id="M" name="M" value="<?php echo ($_SERVER['REQUEST_METHOD'] == 'POST') ? $_POST['M'] : ''; ?>" required><br><br>

    <label for="b">Suku Bunga (b):</label><br>
    <input type="number" id="b" name="b" step="0.01" value="<?php echo ($_SERVER['REQUEST_METHOD'] == 'POST') ? $_POST['b'] : ''; ?>" required><br><br>

    <label for="t">Periode (t):</label><br>
    <input type="number" id="t" name="t" value="<?php echo ($_SERVER['REQUEST_METHOD'] == 'POST') ? $_POST['t'] : ''; ?>" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Logika perhitungan bunga tunggal
    $B = $M * $b * $t;
    $Mn = $M + $B;

    echo "<h3>Hasil Perhitungan:</h3>";
    echo "<p>Bunga (B): Rp " . number_format($B, 2) . "</p>";
