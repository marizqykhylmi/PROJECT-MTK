...
<head>
    ...
    <link rel="icon" href="wikrama-logo.png" type="image/png">
</head>
<!-- HEADER -->
<header>
    <div class="logo">
...
<body>
    <div class="container">
        <h1>Mencari Modal Awal (Bunga Majemuk)</h1>
        <form method="post">
            <label for="Mt">Modal Akhir (Mt):</label><br>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Perhitungan Modal Awal (Bunga Majemuk)
            $M = $Mt / pow((1 + $b), $t);

            echo "<h2>Hasil Perhitungan:</h2>";
            echo "<p>Modal Awal (M): Rp " . number_format($M, 2) . "</p>";
        }
        ?>
    </div>
    <!-- FOOTER -->
